...
class BGGClient:
    ...
    def _make_request(self, endpoint: str, params: Optional[Dict] = None) -> ElementTree.Element:
    ...
    def search_bgg(self, query: str, game_types: str = "boardgame,boardgameexpansion") -> List[Dict]:
